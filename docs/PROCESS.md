...
### 2026-08-13 · README 嵌入双标并做页头视觉

- **原因**：根 README 仍是纯文字表，GitHub 页看不到产品标与实验室主 LOGO。
- **行为变化**：页头居中产品标、徽章、出品双标；增设「产品标识」节嵌入 favicon / 字锁 / LUXI LAB。
- **改动文件**：
  - `README.md` — 页头与标识节
- **验收**：GitHub README 顶部可见观测场标与官方鹿标。
- **残留 / 不做**：未另做 docs/assets 横幅插画。
